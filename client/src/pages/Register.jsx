    ...
    return (
        <div className="max-w-md mx-auto py-12">
            <div className="bg-gray-800 p-8 rounded-3xl border border-gray-700 shadow-2xl">
                <h2 className="text-3xl font-black mb-2 text-center text-blue-400">Join Bellcorp</h2>
                <p className="text-gray-400 text-center mb-8">Start your event journey today</p>
